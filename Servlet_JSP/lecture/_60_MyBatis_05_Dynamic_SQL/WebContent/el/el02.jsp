...
<body>
	...
	<%
		...
		JspContext -> ServletRequest -> HttpSession -> ServletContext -> null // 순서대로 찾아나감.
		*/

		// 테스트를 위한 데이터 객체를 공유공간에 저장하자
		session.setAttribute("scores", new int[] { 90, 80, 70, 100 });
		...
		session.setAttribute("member", new Member().setNo(100).setName("홍길동").setEmail("hong@test.com"));
	%>
