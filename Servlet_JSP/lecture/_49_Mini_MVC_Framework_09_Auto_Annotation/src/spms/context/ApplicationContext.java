 ...
 * @Component 애노테이션 설정된 클래스 객체를 생성하는 역할
*/
...
public class ApplicationContext {
	...
	public ApplicationContext(String propertiesPath) throws Exception {
		...
		prepareObejcts(props); // 프로퍼티 파일에 등록된 클래스 객체 생성
		prepareAnnotationObjects(); // 애노테이션 포함된 클래스 객체 생성
		injectDependency(); // dataSource, memberDao 주입
	}

	private void prepareObejcts(Properties props) throws Exception {
