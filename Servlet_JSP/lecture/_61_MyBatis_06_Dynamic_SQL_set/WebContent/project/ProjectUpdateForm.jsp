	...
	<form action='update.do' method='post'>
		<ul>
			...
			<li>
				...
				<input id="sdate" type="text" name="startDate" placeholder="예)2020-04-01" value="${project.startDate}">
			</li>
			<li>
				<label for="edate">종료일</label>
				<input id="edate" type="text" name="endDate" placeholder="예)2020-04-30" value="${project.endDate}">
			</li>
			<li>
